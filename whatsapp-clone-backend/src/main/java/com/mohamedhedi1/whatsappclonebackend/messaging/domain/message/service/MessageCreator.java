...
import com.mohamedhedi1.whatsappclonebackend.messaging.domain.message.vo.MessagePublicId;
import com.mohamedhedi1.whatsappclonebackend.messaging.domain.message.vo.MessageSendState;
import com.mohamedhedi1.whatsappclonebackend.messaging.domain.message.vo.MessageSentTime;
import com.mohamedhedi1.whatsappclonebackend.messaging.domain.user.aggregate.User;
import  com.mohamedhedi1.whatsappclonebackend.messaging.domain.message.aggregate.MessageBuilder;
...
public class MessageCreator {
    ...
    public State<Message, String> create(MessageSendNew messageSendNew, User sender) {
        ...
        if (conversationToLink.isPresent()) {
            com.mohamedhedi1.whatsappclonebackend.messaging.domain.message.aggregate.Message messageSaved = messageRepository.save(newMessage, sender, conversationToLink.get());
