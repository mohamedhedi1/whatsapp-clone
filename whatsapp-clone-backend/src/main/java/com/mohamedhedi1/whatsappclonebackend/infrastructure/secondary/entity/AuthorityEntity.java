...
import com.mohamedhedi1.whatsappclonebackend.messaging.domain.user.aggregate.Authority;
import com.mohamedhedi1.whatsappclonebackend.messaging.domain.user.vo.AuthorityName;
import com.mohamedhedi1.whatsappclonebackend.messaging.domain.user.aggregate.AuthorityBuilder;
...
public class AuthorityEntity {
    ...
    public static Set<AuthorityEntity> from(Set<Authority> authorities) {
        return authorities
                .stream()
                .map(authority ->
                        com.mohamedhedi1.whatsappclonebackend.infrastructure.secondary.entity.AuthorityEntityBuilder.authorityEntity()
